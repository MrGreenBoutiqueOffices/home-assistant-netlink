...
## Conventions
- Use base entity classes in `custom_components/netlink/entity.py` for device grouping (`NetlinkControllerEntity`, `NetlinkDisplayEntity`). Desk and browser entities both use `NetlinkControllerEntity`.
